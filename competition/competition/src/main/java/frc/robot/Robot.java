...
public class Robot extends TimedRobot {
  ...
  private static final int kRamasseurChannel = 2;
  private static final int kLenceurChannel = 3;
  private static final int kMonteurChannel = 4;
  private static final int kJoystickChannel = 0;

  Spark m_ramasseur = new Spark(kRamasseurChannel);
  Spark m_Lenceur = new Spark(kLenceurChannel);
  Spark m_Monteur = new Spark(kMonteurChannel);
  ...
  public void robotInit() {
    ...
    SmartDashboard.putStringArray("Auto List", new String[] { "safe", "fanci", "nothing", "fanci cote echelle", "fanci cote terminal" });
  }
...
public void autonomousPeriodic() {
  ...
  public void teleopPeriodic() {
    ...
    m_Monteur.set(vitesseRamasseur * 1);
  }
